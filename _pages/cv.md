...
**Email:** 123456789xjdhjj@stu.xjtu.edu.cn | **Phone:** 19890529985 | **Website:** [https://h123s456t.github.io/](https://h123s456t.github.io/)
...
### Scholarships
* Lu Shidi Scholarship (Awarded twice: 2024, 2025)
...
**Ma, S.†, Huang, J.†, Zhang, F., et al.** (2025). "MedLA: A Logic-Driven Multi-Agent Framework for Complex Medical Reasoning with Large Language Models". *Proceedings of the AAAI Conference on Artificial Intelligence (AAAI)*, 2026. (Oral Presentation). †Co-first author

## Professional Skills

* **Programming:** Python (Proficient), C/C++ (Proficient), Java, MATLAB
* **ML Frameworks:** PyTorch
* **Developer Tools:** Git, Linux, Bash Scripting
